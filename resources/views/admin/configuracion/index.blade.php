                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="logo" class="form-label">Logo de la I.E</label>
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group">
                                            <label for="descripcion" class="form-label">Descripcion <b>(*)</b></label>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="telefono" class="form-label">Teléfono <b>(*)</b></label>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="divisa" class="form-label">Divisa <b>(*)</b></label>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="correo_electronico" class="form-label">Correo Electrónico
                                                <b>(*)</b></label>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="web" class="form-label">Sitio Web <b>(*)</b></label>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
