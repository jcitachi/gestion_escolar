...
@section('content_header')
    <h1>Listado de Paralelos Académicos</b></h1>
    <hr class="border-top border-3 border-primary rounded">
@stop

@section('content')
    @include('admin.paralelos.create-modal')
    <div class="row">
        <div class="col-md-6">
                ...
                <div class="card-header bg-primary">
                    ...
                    <div class="card-tools">
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ModalCreate">
                            <i class="fas fa-plus"></i> Crear Nuevo Paralelo
                        </button>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            @foreach ($grados as $grado)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @foreach ($grado->paralelos as $paralelo)
                                        @include('admin.paralelos.edit-modal')
                                            <div class="row justify-content-center mb-2">
                                                ...
                                                <button class="btn btn-sm btn-success mr-2" data-toggle="modal"
                                                    data-target="#ModalUpdate{{ $paralelo->id }}"><i
                                                        class="fas fa-edit"></i>
                                                    Editar</button>
                                                <form action="{{ route('admin.paralelos.destroy', $grado->id) }}"
