...
@section('content_header')
    <h1><b>Actualizar Personal {{ $personal->tipo }}</b></h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 text-center">
                                ...
                                <div class="input-group d-flex flex-column align-items-center">
                                    ...
                                    <!-- Imagen centrada -->
                                    <img id="preview" src="{{ url($personal->foto) }}" width="150"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="rol" id="rol" class="form-control rounded-pill"
                                                ...
                                                @foreach ($roles as $role)
                                                    <option value="{{ $role->name }}" {{ $role->name == $personal->usuario->roles->pluck('name')->implode(', ') ? 'selected' : '' }}> {{ $role->name }} </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nombre" id="nombre"
                                                class="form-control rounded-pill" value="{{ old('nombre', $personal->nombre) }}"
                                               required>
                                        </div>
                                        @error('nombre')
                                            <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="apellido" id="apellido"
                                                class="form-control rounded-pill" value="{{ old('apellido', $personal->apellido) }}"
                                                required>
                                        </div>
                                        @error('apellido')
                                            <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="ci" id="ci"
                                                class="form-control rounded-pill" value="{{ old('ci', $personal->ci) }}"
                                                 required>
                                        </div>
                                        @error('ci')
                                            <small class="text-danger">{{ $message }}</small>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="date" name="fecha_nacimiento" id="fecha_nacimiento"
                                            class="form-control rounded-pill" value="{{ old('fecha_nacimiento', $personal->fecha_nacimiento) }}"
                                            required>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="email" name="email" id="email" value="{{ old('email', $personal->usuario->email) }}"
