...
<body class="bg-gray-50 text-gray-800">
  ...
  <section class="bg-gradient-to-r from-sky-500 to-blue-600 text-white min-h-screen flex items-center">
    <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10">
      ...
      <div class="flex justify-center items-center">
        <img src="https://img.freepik.com/vector-gratis/gestion-escolar-plana_23-2149271827.jpg" alt="Gestión Escolar" class="rounded-xl shadow-lg" data-aos="zoom-in">
      </div>
    </div>
  </section>
  ...
  <section id="about" class="py-20">
    <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
      ...
      <div data-aos="fade-left">
        ...
        <p class="text-lg mb-6">Somos un equipo dedicado a modernizar la gestión escolar con soluciones tecnológicas que simplifican la administración de tu institución.</p>
        <ul class="space-y-2">
  ...
  <section id="contact" class="py-20 bg-gray-100">
    <div class="max-w-7xl mx-auto px-6 text-center">
      ...
      <a href="mailto:soporte@gestion_escolar.test" class="bg-sky-600 text-white px-8 py-3 rounded-lg shadow hover:bg-sky-700">
        Enviar correo
      </a>
    </div>
  </section>
